...
def scrape_and_combine_website(url):
    ...
    if next_page_link:
        ...
        pdf_urls.extend(scrape_and_combine_website(next_page_url))  # Remove the unnecessary variable assignment here
...
print(f"Saving combined PDF to '{combined_pdf_filename}'...")
...
def langchain_search(text, query):
    ...
    #a simple case-insensitive string search
...
# Step 5: Display scraped PDF links and content
print("\nScraped PDF Content:")
print(combined_pdf_text)

print("\nAll Scraped PDF Links:")
...
# Step 6: Save the combined PDF to your system
save_to_system = input("\nDo you want to save the combined PDF to your system? (y/n): ")
if save_to_system.lower() == "y":
    save_path = input("Enter the path to save the PDF (including the file name and .pdf extension): ")
    with open(combined_pdf_filename, "rb") as pdf_file:
        pdf_content = pdf_file.read()
        with open(save_path, "wb") as save_file:
            save_file.write(pdf_content)
